...
This project compares Full Kelly log-growth optimization with drawdown-constrained portfolio optimization using historical daily financial market data.
The objective is to study how leverage, risk limits, and asset correlations impact long-term growth and portfolio drawdowns.
...
(Data sources can be updated as needed — e.g., WRDS, Bloomberg, Federal Reserve.)
...
subject to  drawdown_dev_max(matrix_scenarios) ≤ α
            sum(weights) = 1
...
Run Full Kelly or Drawdown-Constrained optimization
